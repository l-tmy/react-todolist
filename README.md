...
Now you can rename `src/TodoList.css` to `src/TodoList.scss` and update `src/TodoList.jsst.js` to import `src/TodoList.scss`.
...
This is handy if you don't want to load SVG as a separate file. Don't forget the curly braces in the import! The `ReactComponent` import name is special and tells Create React TodoList that you want a React component that renders an SVG, rather than its filename.
...
You don’t have to use [reactstrap](https://reactstrap.github.io/) together with React but it is a popular library for integrating Bootstrap with React apps. If you need it, you can integrate it with Create React TodoList by following these steps:
...
Import required reactstrap components within `src/TodoListoList.js` file or your custom component files:

```js
import { Button } from 'reactstrap';
```

Now you are ready to use the imported reactstrap components within your component hierarchy defined in the render method. Here is an example [`TodoList.jsst.js`](https://gist.githubusercontent.com/zx6658/d9f128cd57ca69e583ea2b5fea074238/raw/a56701c142d0c622eb6c20a457fbc01d708cb485/TodoList.jsst.js) redone using reactstrap.
...
Recent versions of [Flow](https://flow.org/) work with Create React TodoList projects out of the box.
...
4. Add `// @flow` to any files you want to type check (for example, to `src/TodoListoList.js`).
...
Relay is a framework for building data-driven React applications powered by GraphQL. The current release candidate of Relay works with Create React TodoList projects out of the box using Babel Macros. Simply set up your project as laid out in the [Relay documentation](https://facebook.github.io/relay/), then make sure you have a version of the babel plugin providing the macro.
...
Create React TodoList doesn't prescribe a specific routing solution, but [React Router](https://reacttraining.com/react-router/web/) is the most popular one.
...
Create React TodoList intentionally doesn’t support decorator syntax at the moment because:
...
It is shipped with an official Progressive Web TodoList generator as well as a dynamic administration interface, both built for Create React TodoList.
...
However, they [can make debugging deployments more challenging](https://github.com/facebook/create-react-app/issues/2398) so, starting with Create React TodoList 2, service workers are opt-in.
...
| REACT_EDITOR        |   :white_check_mark:   |        :x:         | When an app crashes in development, you will see an error overlay with clickable stack trace. When you click on it, Create React TodoList will try to determine the editor you are using based on currently running processes, and open the relevant source file. You can [send a pull request to detect your editor of choice](https://github.com/facebook/create-react-app/issues/2636). Setting this environment variable overrides the automatic detection. If you do it, make sure your systems [PATH](<https://en.wikipedia.org/wiki/PATH_(variable)>) environment variable points to your editor’s bin folder. You can also set it to `none` to disable it completely. |
